<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="相册图片，多个以逗号分隔" align="center" prop="album" />
      <el-table-column label="视频URL" align="center" prop="video" />
