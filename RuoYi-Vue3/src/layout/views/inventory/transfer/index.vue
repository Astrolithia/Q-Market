<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="transferList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="调拨总数量" align="center" prop="totalQuantity" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['inventory:transfer:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['inventory:transfer:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
